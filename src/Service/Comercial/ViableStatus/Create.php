<?php
namespace App\Service\Comercial\ViableStatus;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\Validator\Constraints as Assert;
use Symfony\Component\Validator\Validation;
use App\Entity\Comercial\ViableStatus as EntityViableStatus;
...
class Create
{
    ...
    public function create(Request $objRequest)
    {
        try {
            ...
            $this->objViableStatus = new EntityViableStatus();
            $this->objViableStatus->setName($objRequest->get('name', NULL));
    ...
    {
        $this->objEntityManager->persist($this->objViableStatus);
        $this->objEntityManager->flush();
        return $this->objViableStatus;
    }
}
